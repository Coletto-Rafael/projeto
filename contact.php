        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="category.html">Categoria <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-4 offset-md-0">
            <div class="card">
                <div class="card-header bg-primary text-white"><i class="fa fa-envelope"></i> Contatos.
                </div>
                <div class="card-body">
                    <form>
